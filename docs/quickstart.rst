...
.. |django_key| raw:: html
	...
	<a href="http://www.miniwebtool.com/django-secret-key-generatory" target="_blank">here</a>
...
with your prjeoct name and your own secret key.

Next, edit the **predeactivate** file and add the line::

	unset SECRET_KEY

Repeast the last steps for your testing environment::
...
Next, install the packages in each environment::
	...
	$ workon tb_test
	$ pip install -r requirments/testing.txt
